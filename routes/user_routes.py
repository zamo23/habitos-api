...
user_bp.add_url_rule('/users/me/local-time', view_func=get_local_time, methods=['GET'])
user_bp.add_url_rule('/users/me/recent-activity', view_func=get_recent_activity, methods=['GET'])
user_bp.add_url_rule('/users/me/activity-heatmap', view_func=get_activity_heatmap, methods=['GET'])
user_bp.add_url_rule('/users/me/habit-summary', view_func=get_habit_summary, methods=['GET'])
user_bp.add_url_rule('/users/me/weekly-progress', view_func=get_weekly_progress, methods=['GET'])